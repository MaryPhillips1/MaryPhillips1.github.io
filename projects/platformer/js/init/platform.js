(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(300, 600, .75, .75);       
        platform.create(450, 550, .5, .5);
        platform.create(650, 500, .5, .5);
        platform.create(500, 200, .5, .5);
        platform.create(150, 350, .5, .5);
        platform.create(200, 450, .75, .5);
